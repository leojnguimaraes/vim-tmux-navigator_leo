...
# Colocando setas para mudar de painel:
tmux bind-key -n C-left  if-shell "$is_vim" "send-keys C-h" "select-pane -L"
tmux bind-key -n C-down  if-shell "$is_vim" "send-keys C-j" "select-pane -D"
tmux bind-key -n C-up    if-shell "$is_vim" "send-keys C-k" "select-pane -U"
tmux bind-key -n C-right if-shell "$is_vim" "send-keys C-l" "select-pane -R"
